...
import { Row, Col, CardBody, Card, Alert, Container, Form, Input, FormFeedback, InputGroup, Button } from 'reactstrap';
...
const urlRegisterLandingPage = import.meta.env.VITE_APP_BASEURL_REGISTER_LANDING_PAGE;
...
const Login = (props) => {
  ...
  const validation = useFormik({
    ...
    onSubmit: (values) => {
      if (doSubmit()) {
        toastifyService.customShowLoading({ title: 'Harap Tunggu', msg: 'Proses Login...' });
  ...
  return (
    <React.Fragment>
      <div className="account-pages bg-white" style={{ height: '100%', minHeight: '100vh' }}>
        <div className="d-flex flex-column justify-content-center align-items-center pt-2 pt-md-5">
          <Container className="h-100">
                    ...
                    <CardBody className="p-5">
                      ...
                      >
                        <div className="text-center mb-3">
                          ...
                          <h1 className="fs-6 fw-light text-secondary lh-1">Silahkan isi informasi anda</h1>
                        </div>
                        ...
                        <div className="mb-3 w-100 d-flex justify-content-between">
                          <Link to="/forgot-password" className="fw-semibold text-primary">
                            Lupa Password?
                          </Link>
                        </div>
                        <Row className="mb-3 row-gap-2">
                          <Col lg={6} xl={7}>
                            <Input
                              ...
                              onChange={validation.handleChange}
                              onBlur={validation.handleBlur}
                              invalid={validation.touched.verification && validation.errors.verification ? true : false}
                            />
                            {validation.touched.verification && validation.errors.verification ? <FormFeedback type="invalid">{validation.errors.verification}</FormFeedback> : null}
                          </Col>
                        ...
                        <div className="mt-5 w-100">
                          <button tabIndex={4} className="btn btn-primary btn-block w-100" type="submit">
                            Selanjutnya
                          </button>
                        </div>

                        <div className="w-100 my-3" style={{ borderTop: '1px solid #d1d5db' }}></div>
                        <Row>
                          <Col xs={12}>
                            <Button className="w-100" color="success" onClick={loginSSO}>
                              Login Portal Dengan SSO <i className="bx bx-right-arrow-alt" />
                            </Button>
                          </Col>
                        </Row>
                      </Form>
            ...
            <div className="w-100 d-flex align-items-center justify-content-center fs-6 mb-5">
              ...
              <div className="cursor-pointer" onClick={() => (window.location.href = urlRegisterLandingPage)}>
