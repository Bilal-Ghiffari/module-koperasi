...
const UploadImageVertical = ({ formik }) => {
  ...
  const handleFileSelect = (file) => {
    if (file && file.type.startsWith("image/")) {
      if (file.size <= 5 * 1024 * 1024) {
        ...
        formik.setFieldValue("file_lambang_partai", file, true);
      } else {
  ...
  return (
    <section className="mb-4">
      <Label className="m-0 pb-2" htmlFor="file_lambang_partai">
        Lambang atau Tanda Gambar Partai Politik{" "}
      ...
      {formik.touched.file_lambang_partai &&
        formik.errors.file_lambang_partai && (
          <Typography
            variant="body2"
            sx={{
              color: "#d32f2f",
