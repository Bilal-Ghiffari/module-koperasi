              ...
              >
                ...
                <div style={{ fontSize: 12, marginTop: 30, lineHeight: 1.6 }}>
                  ...
                  >
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>: {formik.values.id_kewarganegaraan_pasangan}</td>
                      </tr>
                      <tr>
                        ...
                        <td>
                          <div>
                            ...
                            <ul style={{ margin: 0, paddingLeft: 20 }}>
                              ...
                              <li>
                                diterbitkan di:{" "}
                                {formik.values.wilayah_paspor_ri_pemohon}
                              </li>
                              <li>
                  ...
                  <div style={{ marginBottom: 30 }}>
                    Bahwa diindonesia, pada tanggal 09 November 2017, telah
                    dilangsungkan perkawinan antara saya dengan Riadi Jones;
                    Bahwa suami saya (Riadi Jones) adalah kewarganegaraan
                    France; Bahwa berdasarkan uraian tersebut, saya dengan ini
                    menyatakan untuk tetap mempertahankan kewarganegaraan saya,
                    yaitu Kewarganegaraan Republik Indonesia dan menolak
                    Kewarganegaraan suami saya, yaitu Kewarganegaraan France;
                  </div>
                  <div style={{ marginBottom: 30 }}>
