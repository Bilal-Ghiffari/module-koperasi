// File: components/FormFidusia AlamatIndonesia;.js
      ...
      <Box className="form-horizontal">
        <Row>
          <Region
            formik={formik}
            disabled={disabled}
            provinsiKey="identity_pemberi.provinsi"
            kabupatenKey="identity_pemberi.kabupaten"
            kecamatanKey="identity_pemberi.kecamatan"
            kelurahanKey="identity_pemberi.kelurahan"
            required
          />
        </Row>
        <Row>
