...
const FormKemauanSendiri = lazy(() =>
  import("@/pages/Modules/Kewarganegaraan/PernyataanWni/KemauanSendiri")
);

const FormPunyaWna = lazy(() =>
  import("@/pages/Modules/Kewarganegaraan/PernyataanWni/PunyaWna")
);

const FormBelumPunyaWna = lazy(() =>
  import("@/pages/Modules/Kewarganegaraan/PernyataanWni/BlmPunyaWna")
);

const FormIkutPasangan = lazy(() =>
  import("@/pages/Modules/Kewarganegaraan/PernyataanWni/IkutPasangan")
);
