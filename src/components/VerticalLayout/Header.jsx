  ...
  const modules = [
    {
      ...
      color: '#FFA55D',
      keterangan: 'Digunakan sebagai User Interface untuk pengaturan dan pengelolaan hak akses penggunaan. Dilengkapi dengan sistem Single Sign-On (SSO) dan kemampuan otentikasi melalui email.'
    },
    {
      module: 'Modul 2',
      module_code: '23',
